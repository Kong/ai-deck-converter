---
title: OpenID Connect Plugin Configuration Reference
description: Integrate Kong Gateway with a third-party OpenID Connect provider
...
# OpenID Connect Plugin Configuration Reference
    ...
    "config": {
      "properties": {
        ...
        "cluster_cache_strategy": {
          "default": "off",
          "description": "The strategy to use for the cluster cache. If set, the plugin will share introspection cache with nodes configured with the same strategy backend.",
          "enum": [
            "off",
            "redis"
          ],
...
- [OpenID Connect in Kong Gateway](/gateway/openid-connect/)

- [Authentication in Kong Gateway](/gateway/authentication/)

- [OpenID Connect tutorials](/how-to/?query=openid-connect)
